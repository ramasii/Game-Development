...
- [[GDD - Awan Tukang Hujan]] — GDD lengkap: konsep, core loop endless, mekanik (Opsi A slot), arsitektur, FTUE tanpa teks, folder modular, scope.
- [[Planning - Awan Tukang Hujan]] — Planning eksekusi terpisah: flow MainMenu → InGame → Pause → GameOver, scene breakdown, task 2 minggu, balancing anchors, Go/No-Go.
...
### 🏗️ Game Architecture
- [[Single Source of Truth (SSOT)]] — BalanceConfigSO untuk semua timer.
...
- [[Dirty Flag Pattern (Unity)]] + [[Flyweight Pattern (Unity Shared Data)]] — hemat update visual.
...
- [[Tutorial Level Building Blocks]] — layout planet + onboarding spasial.
- [[Framework Kihon-Kata-Kumite (Learning Curve & Encounter Design)]] — Kihon merge, Kata hujan tepat, Kumite rotasi multi-lahan.

### 🏛️ Level & Balancing
- [[Level Design Workflow (Whiteblocking & Modular)]] — whitebox 12 slot + 2 air + 6 tanaman.
- [[Apply Balance Foundations]] + [[Map Resource Flows]] + [[Establish Math Anchors]] + [[Spreadsheet Setup]] — timer survival endless.
...
| **Aturan** | No angka & huruf di gameplay, no chocolate-covered broccoli, no win, lose = tanaman habis |

### 🚦 Phase Progress

- [x] Konsep + sketsa siklus + planet melingkar
- [x] GDD dibuat
- [x] Planning dibuat
- [ ] **Phase 0** — Core + Planet whitebox + PlantManager AliveTracker
