...
- [[GDD - Awan Tukang Hujan]] — GDD lengkap: konsep, core loop endless, mekanik 40 slot Opsi A, arsitektur, FTUE tanpa teks, folder modular, scope.
...
### 🏗️ Game Architecture
- [[Single Source of Truth (SSOT)]] — BalanceConfigSO untuk semua timer + counts (34/6/17).
...
- [[State Pattern (Unity FSM)]] — Cloud / Soil x34 / Plant state machine.
- [[Observer Pattern Events]] — EventChannel decoupled.
- [[Factory Pattern (Unity)]] + [[Object Pool Pattern (Unity)]] — spawn awan/hujan/uap (wajib untuk 40 slot).
- [[MVP Pattern (Unity UI)]] — UI ikon-only, HUD cuma Pause.
- [[Dirty Flag Pattern (Unity)]] + [[Flyweight Pattern (Unity Shared Data)]] — hemat update 34 soil.
...
- [[Tutorial Level Building Blocks]] — layout planet 40 slot + onboarding spasial.
- [[Framework Kihon-Kata-Kumite (Learning Curve & Encounter Design)]] — Kihon merge, Kata hujan tepat, Kumite rotasi multi-lahan.

### 🏛️ Level & Balancing
- [[Level Design Workflow (Whiteblocking & Modular)]] — whitebox 40 slot (34 soil + 6 water) + tanaman initial 17.
- [[Apply Balance Foundations]] + [[Map Resource Flows]] + [[Establish Math Anchors]] + [[Spreadsheet Setup]] — timer survival endless + rasio air:tanah 6:34.
...
| **Aturan** | No angka & huruf di gameplay, no chocolate-covered broccoli, no win, lose = tanaman habis, planet 40 slot |
| **Planet** | 40 slot (34 soil + 6 water), tanaman initial 17 maks 34 |

### 🚦 Phase Progress

- [x] Konsep + sketsa siklus + planet melingkar 40 slot
- [x] GDD dibuat (40 slot)
- [x] Planning dibuat (40 slot)
- [x] Prompts eksekusi dibuat (P0–P7)
- [ ] **Phase 0** — Core + Planet 40 slot whitebox + PlantManager AliveTracker
